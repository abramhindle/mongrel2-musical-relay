...
instr Generator
      ...
      itab = 1
      iamp = 1
      ga01   oscil iamp,  1*ioff  , itab
      ga02   oscil iamp,  2*ioff  , itab
      ga03   oscil iamp,  3*ioff  , itab
      ga04   oscil iamp,  4*ioff  , itab
      ga05   oscil iamp,  5*ioff  , itab
      ga06   oscil iamp,  6*ioff  , itab
      ga07   oscil iamp,  7*ioff  , itab
      ga08   oscil iamp   8*ioff  , itab
;      ga09   oscil iamp,  9*ioff  , itab
;      ga10   oscil iamp, 10*ioff  , itab
endin
...
;      ia9 = p13
;      ia10 = p14
      itotal = ia1 + ia2 + ia3 + ia4 + ia5 + ia6 + ia7 + ia8
      iratio = iamp / itotal
      asum = iratio * ia1 * ga1 + iratio * ia2 * ga2 + iratio * ia3 * ga3 + iratio * ia4 * ga4 + iratio * ia5 * ga5 + iratio * ia1 * ga6 + iratio * ia2 * ga7 + iratio * ia3 * ga8 
endin
