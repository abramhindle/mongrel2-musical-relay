...
jack_connect  csoundClothe:output1 csoundDropMixer:input3

jack_connect  csoundVoronoi:output1 csoundDropMixer:input3

#right

jack_connect  csoundForce:output1 csoundDropMixer:input2

jack_connect  csoundEnveloper:output1 csoundDropMixer:input4
